...
from .views import company_list, company_detail, get_vacancies_by_company, vacancy_list, vacancy_detail, top_ten_vacancies

urlpatterns = [
    path('companies/', company_list, name='company_list'),
    path('companies/<int:id>/', company_detail, name='company_detail'),
   path('companies/<int:company_id>/vacancies/', get_vacancies_by_company, name='company-vacancies'),
